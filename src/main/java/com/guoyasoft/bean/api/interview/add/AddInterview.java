...
public class AddInterview implements java.io.Serializable {
    ...
    public AddInterview() {
        super();
    } //-- com.guoyasoft.bean.api.interview.add.AddInterview()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.api.interview.add.AddInterview unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.api.interview.add.AddInterview) Unmarshaller.unmarshal(com.guoyasoft.bean.api.interview.add.AddInterview.class, reader);
    } //-- com.guoyasoft.bean.api.interview.add.AddInterview unmarshal(java.io.Reader) 
