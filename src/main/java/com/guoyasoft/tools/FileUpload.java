...
public class FileUpload {
	...
	public static HashMap<String, Object> fileupload(
		...
		parameters.put("filePathes", filePathes);
		// 获取item中的上传文件的输入流
		InputStream in = null;
		// 创建一个文件输出流
		...
		// String savePath =
		// request.getServletContext().getRealPath("\\").replace("server",
		// "client")+"basicClass\\images\\summarizes";
		// String savePath =
		// request.getServletContext().getRealPath("/").replace("guoya-client",
		// "guoya-client")+"basicClass/images/summarizes";
	...
	public static void saveFile(HttpServletRequest request, String savePath)
			throws ServletException, IOException {
		// 获取item中的上传文件的输入流
		InputStream in = null;
		// 创建一个文件输出流
