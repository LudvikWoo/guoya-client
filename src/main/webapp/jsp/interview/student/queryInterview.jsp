						...
						<form id="form" action="interview/queryInterview.action" target="result"
							...
							<div class="form-group">
								...
								<div class="col-lg-2 col-md-2 col-sm-4">
									<input type="text" name="custmerName" class="form-control" value="${studentName }" disabled="disabled">
								</div>

								<label class="col-lg-1 col-md-1 col-sm-2 control-label">所属班级</label>
								<div class="col-lg-2 col-md-2 col-sm-4">
									<input type="text" name="classId" class="form-control" value="${classId }" disabled="disabled">
								</div>
