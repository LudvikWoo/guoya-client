...
public class ContactInfo implements java.io.Serializable {
    ...
    } //-- com.guoyasoft.bean.api.test.queryCustomer.request.ContactInfo()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.api.test.queryCustomer.request.ContactInfo unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.api.test.queryCustomer.request.ContactInfo) Unmarshaller.unmarshal(com.guoyasoft.bean.api.test.queryCustomer.request.ContactInfo.class, reader);
    } //-- com.guoyasoft.bean.api.test.queryCustomer.request.ContactInfo unmarshal(java.io.Reader) 
