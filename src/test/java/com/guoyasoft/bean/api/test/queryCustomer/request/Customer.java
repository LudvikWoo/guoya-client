...
public class Customer implements java.io.Serializable {
    ...
    public Customer() {
        super();
    } //-- com.guoyasoft.bean.api.test.queryCustomer.request.Customer()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.api.test.queryCustomer.request.Customer unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.api.test.queryCustomer.request.Customer) Unmarshaller.unmarshal(com.guoyasoft.bean.api.test.queryCustomer.request.Customer.class, reader);
    } //-- com.guoyasoft.bean.api.test.queryCustomer.request.Customer unmarshal(java.io.Reader) 
