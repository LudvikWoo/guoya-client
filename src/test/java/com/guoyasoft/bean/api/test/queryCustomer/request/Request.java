...
public class Request implements java.io.Serializable {
    ...
    public Request() {
        super();
    } //-- com.guoyasoft.bean.api.test.queryCustomer.request.Request()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.api.test.queryCustomer.request.Request unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.api.test.queryCustomer.request.Request) Unmarshaller.unmarshal(com.guoyasoft.bean.api.test.queryCustomer.request.Request.class, reader);
    } //-- com.guoyasoft.bean.api.test.queryCustomer.request.Request unmarshal(java.io.Reader) 
