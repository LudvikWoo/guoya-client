...
package com.guoyasoft.bean.api.test.queryCustomer.response;
...
public class Response implements java.io.Serializable {
    ...
    private java.lang.String _customerStatus;
    ...
    public Response() {
        super();
    } //-- com.guoyasoft.bean.api.test.queryCustomer.response.Response()
    ...
    **/
    ...
    /**
     * Returns the value of field 'customerStatus'.
     * 
     * @return the value of field 'customerStatus'.
    **/
    ...
    **/
    ...
    /**
     * Sets the value of field 'customerStatus'.
     * 
     * @param customerStatus the value of field 'customerStatus'.
    **/
    public void setCustomerStatus(java.lang.String customerStatus)
    {
        this._customerStatus = customerStatus;
    } //-- void setCustomerStatus(java.lang.String) 
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.bean.api.test.queryCustomer.response.Response unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.bean.api.test.queryCustomer.response.Response) Unmarshaller.unmarshal(com.guoyasoft.bean.api.test.queryCustomer.response.Response.class, reader);
    } //-- com.guoyasoft.bean.api.test.queryCustomer.response.Response unmarshal(java.io.Reader) 
